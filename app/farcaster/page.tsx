    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {!walletAddress ? (
        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-6">
          <p className="text-yellow-700">Please connect your wallet to interact with the blockchain features.</p>
        </div>
      ) : null}
      ...
      {movies.length > 0 && currentMovie ? (
        ...
        <div className="flex items-center justify-center h-64 bg-gray-100 rounded-lg">
          <p className="text-gray-500">{walletAddress ? "Loading movies..." : "Connect your wallet to view movies"}</p>
        </div>
      )}
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-md p-4">
        ...
        <p className="text-blue-700">
          This page demonstrates how the Farcaster Mini App integrates with the Celo blockchain. When you vote on a
          movie, a transaction is sent to the MovieMeter smart contract on the Celo Alfajores testnet.
        </p>
      </div>
    </div>
  )
